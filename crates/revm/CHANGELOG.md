...
## [9.1.0](https://github.com/Evalir/revm/compare/revm-v9.0.0...revm-v9.1.0) - 2024-05-20
...
### Other
- cleanup host blockhash fn ([#1430](https://github.com/Evalir/revm/pull/1430))
...
- *(deps)* bump anyhow from 1.0.82 to 1.0.83 ([#1404](https://github.com/Evalir/revm/pull/1404))
