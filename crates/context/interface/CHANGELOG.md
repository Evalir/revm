...
## [8.0.0](https://github.com/Evalir/revm/compare/revm-context-interface-v7.0.1...revm-context-interface-v8.0.0) - 2025-06-26

### Added

- implement `Transaction` for `Either` ([#2662](https://github.com/Evalir/revm/pull/2662))
- optional_eip3541 ([#2661](https://github.com/Evalir/revm/pull/2661))

### Other

- fix copy-pasted inner doc comments ([#2663](https://github.com/Evalir/revm/pull/2663))
