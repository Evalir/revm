...
## [7.1.1](https://github.com/Evalir/revm/compare/revm-primitives-v7.1.0...revm-primitives-v7.1.1) - 2024-07-19

### Other
- Renamed some city name ([#1645](https://github.com/Evalir/revm/pull/1645))
...
- *(eof)* simplify magic checks ([#1633](https://github.com/Evalir/revm/pull/1633))
