...
## [1.0.0](https://github.com/Evalir/revm/releases/tag/revm-optimism-v1.0.0) - 2024-10-28
...
- introducing EvmWiring, a chain-specific configuration ([#1672](https://github.com/Evalir/revm/pull/1672))
...
- make macro crate-agnostic ([#1802](https://github.com/Evalir/revm/pull/1802))
...
- Test for l1 gas used and l1 fee for ecotone tx ([#1748](https://github.com/Evalir/revm/pull/1748))
- *(deps)* bump anyhow from 1.0.88 to 1.0.89 ([#1772](https://github.com/Evalir/revm/pull/1772))
